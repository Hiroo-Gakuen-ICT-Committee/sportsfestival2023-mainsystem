...
const connection = mysql.createConnection({
  host: '192.168.10.4',
  user: 'sportsfestival2023',
  password: 'HVvGw9WFHfm,',
  database: 'sportsfestival2023',
});
app.use(
  session({
...
app.post("/login", (req, res) => {
  ...
  } else if (username === "hglib" && password === "sports") {
    req.session.username = 'hglib';
    req.session.password = 'sports';
    res.redirect("/manage");
...
app.get("/manage", (req, res) => {
  if (req.session.username == "hglib" && req.session.password == "sports") {
    connection.query(
      "SELECT * FROM setting",
      (error, results10) => {
        connection.query(
                                    ...
                                    connection.query(
                                      ...
                                      (error, results8) => {
                                        connection.query(
                                          "SELECT * FROM results",
                                          (error, results9) => {
                                            res.render("manage.ejs", { settings: results10, points1: results, points2: results2, points3: results3, plus1: results4, plus2: results5, plus3: results6, colors: results7, pluscolor: results8, compresults: results9 });
                                          }
                                        );
                                      }
                                    );
...
app.post("/classscore", (req, res) => {
  ...
  var sorted = arr.slice().sort(function (a, b) { return a.time - b.time });

  var ranks = arr.slice().map(function (x) {
    return sorted.indexOf(x) + 1
  });
  var sorted2 = arr.slice().sort(function (a, b) { return b.time - a.time });
  const date = new Date();
                        ...
                        (error, results6) => {
                          if (results6[0].subject == "double") {
                            connection.query(
                              ...
                              (error, results7) => {
                                connection.query(
                                  "INSERT INTO pointscolor (competition,??,??,??,??,??,??,??) SELECT competition,first,second,third,fourth,fifth,sixth,seventh FROM pointsmh1 WHERE competition=?",
                                  [
                                    results7[0].colorm11,
                                    results7[0].colorm12,
                                    results7[0].colorm13,
                        ...
                        (error, results6) => {
                          if (results6[0].subject == "double") {
                            connection.query(
                              ...
                              (error, results7) => {
                                connection.query(
                                  "INSERT INTO pointscolor (competition,??,??,??,??,??,??,??) SELECT competition,first,second,third,fourth,fifth,sixth,seventh FROM pointsmh2 WHERE competition=?",
                                  [
                                    results7[0].colorm21,
                                    results7[0].colorm22,
                                    results7[0].colorm23,
...
app.post("/classrenew", (req, res) => {
  ...
  if (req.body.competition == "大縄跳び") {
    if (req.body.grade == "M1") {
                                    ...
                                    connection.query(
                                      ...
                                      (error, results8) => {
                                        connection.query(
                                          ...
                                          (error, results10) => {
                                            connection.query(
                                              "INSERT INTO reducedatas (grade,competition,reason,times) VALUES (?,?,?,?)",
                                              [
                                                req.body.competition,
                                                req.body.grade,
                                                req.body.anything,
      ...
      connection.query(
        "DELETE FROM results WHERE compname=?",
        [req.body.competition],
        (error, results) => {
          connection.query(
            "INSERT INTO results (compname,grade,time1,time2,time3,time4,time5,time6,time7,rank1,rank2,rank3,rank4,rank5,rank6,rank7) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
              ...
              connection.query(
                ...
                (error, results2) => {
                  connection.query(
                    ...
                    (error, results3) => {
                      connection.query(
                        "INSERT INTO pointsmh2 (competition,??,??,??,??,??,??,??,subject) SELECT compname,point1,point2,point3,point4,point5,point6,point7,subject FROM results WHERE compname=?   ",
                        [
                          sorted2[0].class,
                          sorted2[1].class,
                          sorted2[2].class,
                        ...
                        (error, results4) => {
                          connection.query(
                            "UPDATE plus2 SET first=(SELECT SUM(first) FROM pointsmh2),second=(SELECT SUM(second) FROM pointsmh2),third=(SELECT SUM(third) FROM pointsmh2),fourth=(SELECT SUM(fourth) FROM pointsmh2),fifth=(SELECT SUM(fifth) FROM pointsmh1),sixth=(SELECT SUM(sixth) FROM pointsmh2),seventh=(SELECT SUM(seventh) FROM pointsmh2)",
                            (error, results5) => {
                              connection.query(
                                "SELECT * FROM pointsmh2 WHERE competition=?",
                                [
                                  req.body.competition
                                ],
                                (error, results6) => {
              ...
              connection.query(
                ...
                (error, results2) => {
                  connection.query(
                    ...
                    (error, results3) => {
                      connection.query(
                        "INSERT INTO pointsmh1 (competition,??,??,??,??,??,??,??,subject) SELECT compname,point1,point2,point3,point4,point5,point6,point7,subject FROM results WHERE compname=?",
                        [
                          sorted[0].class,
                          sorted[1].class,
                          sorted[2].class,
                        ...
                        (error, results4) => {
                          connection.query(
                            ...
                            (error, results5) => {
                              connection.query(
                                "SELECT * FROM pointsmh1 WHERE competition=?",
                                [
                                  req.body.competition
                                ],
                                (error, results6) => {
              ...
              connection.query(
                ...
                (error, results2) => {
                  connection.query(
                    ...
                    (error, results3) => {
                      connection.query(
                        "INSERT INTO pointsmh3 (competition,??,??,??,??,??,??,??,subject) SELECT compname,point1,point2,point3,point4,point5,point6,point7,subject FROM results WHERE compname=?",
                        [
                          sorted[0].class,
                          sorted[1].class,
                          sorted[2].class,
                        ...
                        (error, results4) => {
                          connection.query(
                            ...
                            (error, results5) => {
                              connection.query(
                                "SELECT * FROM pointsmh3 WHERE competition=?",
                                [
                                  req.body.competition
                                ],
                                (error, results6) => {
  ...
  if (req.body.grade == "M1") {
    ...
    if (req.body.reasons == "half") {
      connection.query(
        ...
        (error, results5) => {
          connection.query(
            "UPDATE plus3 SET first=(SELECT SUM(first) FROM pointsmh3),second=(SELECT SUM(second) FROM pointsmh3),third=(SELECT SUM(third) FROM pointsmh3),fourth=(SELECT SUM(fourth) FROM pointsmh3),fifth=(SELECT SUM(fifth) FROM pointsmh1),sixth=(SELECT SUM(sixth) FROM pointsmh3),seventh=(SELECT SUM(seventh) FROM pointsmh3)",
            (error, results5) => {
              connection.query(
                "SELECT * FROM pointsmh3 ORDER BY id DESC LIMIT 1",
                (error, results6) => {
  ...
  connection.query(
    ...
    (error, results) => {
      connection.query(
        ...
        (error, results2) => {
          connection.query(
            "INSERT INTO pointscolor (competition,??,??,??,??,??,??,??) SELECT compname,point1,point2,point3,point4,point5,point6,point7 FROM colorresults WHERE compname=?",
            [
              sorted[0].class,
              sorted[1].class,
              sorted[2].class,
...
app.post("/colorreduce", (req, res) => {
  if (req.body.reasons == "half") {
    connection.query(
      "UPDATE pointscolor SET ??=TRUNCATE(??/2,0) WHERE competition=?",
      [
        req.body.classes,
        req.body.classes,
        req.body.competition,
    ...
    connection.query(
      "UPDATE pointscolor SET ??=0 WHERE competition=?",
      [
        req.body.classes,
        req.body.competition,
      ],
